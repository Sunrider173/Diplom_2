...
class TestCreateOrder:
    ...
    @allure.description("Создание заказа неавторизованным пользователем с ингредиентами")
    ...
    @allure.description("Создание заказа с невалидным хешем ингредиентов должно возвращать ошибку")
